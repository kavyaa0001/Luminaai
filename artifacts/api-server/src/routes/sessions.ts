...
router.post("/sessions/:id/analyze", async (req: any, res: any) => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
...
router.post("/sessions/:id/quiz", async (req: any, res: any) => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
...
router.get("/sessions/:id/attempts", async (req: any, res: any) => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
  try {
